...
export const curatedIssues: Issue[] = [
  ...
  {
    id: "swiftui-animations-072",
    title: "Document phase animator best practices for scroll-driven effects",
    repo: "apple/swift-ui-labs",
    org: "SwiftUI Labs",
    description:
      "Expand the animation cookbook with a section on scroll-driven phase animators that highlights accessibility-safe defaults.",
    labels: ["docs", "ios", "animation"],
    language: "Swift",
    level: "intermediate",
    link: "https://github.com/apple/swift-ui-labs/issues/72",
    stars: 18000,
    updatedAt: "2024-07-04T14:30:00.000Z",
    goodFirstIssue: false,
    topics: ["swiftui", "animation", "a11y"],
  },
  {
    id: "elixir-telemetry-410",
    title: "Add OpenTelemetry exemplar support to Phoenix LiveDashboard",
    repo: "phoenixframework/phoenix_live_dashboard",
    org: "Phoenix",
    description:
      "Expose exemplar sampling controls so BEAM apps can export latency exemplars to Prometheus-compatible scrapers.",
    labels: ["feature", "observability", "backend"],
    language: "Elixir",
    level: "advanced",
    link: "https://github.com/phoenixframework/phoenix_live_dashboard/issues/410",
    stars: 5100,
    updatedAt: "2024-07-09T09:12:00.000Z",
    goodFirstIssue: false,
    topics: ["telemetry", "prometheus", "elixir"],
  },
  {
    id: "kotlin-compose-189",
    title: "Improve accessibility semantics for lazy staggered grids",
    repo: "androidx/androidx",
    org: "AndroidX",
    description:
      "Teach compose-foundation to emit collection semantics for lazy staggered grids so TalkBack announces indices.",
    labels: ["accessibility", "good first issue"],
    language: "Kotlin",
    level: "first-timers",
    link: "https://github.com/androidx/androidx/issues/3119",
    stars: 120000,
    updatedAt: "2024-07-03T22:45:00.000Z",
    goodFirstIssue: true,
    topics: ["compose", "android", "a11y"],
  },
  {
    id: "laravel-cache-712",
    title: "Allow tagged cache warmers to use async queues",
    repo: "laravel/framework",
    org: "Laravel",
    description:
      "Introduce a cache:prime command that dispatches tagged warmers onto queue workers with per-tag progress output.",
    labels: ["feature", "php", "backend"],
    language: "PHP",
    level: "intermediate",
    link: "https://github.com/laravel/framework/issues/52471",
    stars: 76000,
    updatedAt: "2024-07-11T06:02:00.000Z",
    goodFirstIssue: false,
    topics: ["laravel", "cache", "queues"],
  },
  {
    id: "dotnet-asp-598",
    title: "Expose antiforgery diagnostics in minimal APIs",
    repo: "dotnet/aspnetcore",
    org: ".NET",
    description:
      "Add analyzers + middleware hooks so minimal API apps can log antiforgery validation failures with correlation IDs.",
    labels: ["diagnostics", "security", "help wanted"],
    language: "C#",
    level: "advanced",
    link: "https://github.com/dotnet/aspnetcore/issues/57862",
    stars: 65000,
    updatedAt: "2024-07-10T17:20:00.000Z",
    goodFirstIssue: false,
    topics: ["dotnet", "security", "diagnostics"],
  },
  {
    id: "scala-zio-203",
    title: "Add chunked stream interop between ZIO HTTP and Akka",
    repo: "zio/zio-http",
    org: "ZIO",
    description:
      "Design a helper that converts Akka Http entity streams into ZIO HTTP bodies without leaking fibers.",
    labels: ["interop", "backend", "help wanted"],
    language: "Scala",
    level: "intermediate",
    link: "https://github.com/zio/zio-http/issues/203",
    stars: 6000,
    updatedAt: "2024-07-01T12:18:00.000Z",
    goodFirstIssue: false,
    topics: ["zio", "streams", "scala"],
  },
];
